...
public class Actualizar extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            preparedStatement.setString(1, cli.getText());
            preparedStatement.setString(2, pc.getText());
            preparedStatement.setString(3, tdj.getText());
            preparedStatement.setString(4, ar.getText());
            preparedStatement.setString(5, adst.getText());
            preparedStatement.setString(6, net.getText());
            preparedStatement.setString(7, nei.getText());
